  ...
  <Dialog :title="dialogTitle" v-model="dialogVisible">
    ...
    <el-form-item label="选择店铺" prop="shopId">
      ...
      <el-form-item label="提现到银行卡" prop="bankId">
        <el-select v-model="formData.bankId" placeholder="选择银行卡">
          <el-option
      ...
      <!-- <el-form-item label="状态:0=未审核,1=待到账,2=审核拒绝,3=已到账" prop="status">
...
const open = async (type: string, id?: number) => {
  ...
  if (id) {
    ...
    try {
      ...
      bankList.value.push(formData.value.userBank)
    } finally {
